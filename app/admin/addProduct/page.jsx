...
const page = () => {
    ...
    return (
        <>
            <form onSubmit={onSubminHandler} className='pt-5 px-5 sm:pt-12 sm:pl-16'>
                ...
                <select name="category" onChange={onChangeHandler} value={data.category} className='w40 mt-4 px-4 py-3 border text-gray-500'>
