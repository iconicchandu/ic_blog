...
import { Mail, Lock, User, Loader2, Settings } from "lucide-react"
import { ConnectionTest } from "./connection-test"
import { ApiKeyValidator } from "../debug/api-key-validator"
        ...
        <Card className="w-full max-w-md mx-auto">
          <CardHeader className="space-y-1">
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-2xl font-bold">Welcome to IC Blog</CardTitle>
                <CardDescription>Sign in to access the admin panel</CardDescription>
              </div>
              <Button variant="ghost" size="sm" onClick={() => setShowDebug(!showDebug)} className="p-2">
